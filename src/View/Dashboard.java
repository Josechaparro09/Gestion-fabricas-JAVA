...
public class Dashboard extends javax.swing.JFrame {
    ...
    public void empleadoEditable(boolean ed){
        ...
        txtNombreEmp.setEditable(ed);
        txtApellidosEmp.setEditable(ed);
        txtTelefonoEmp.setEditable(ed);
        txtccEmp.setFocusable(ed);
        txtNombreEmp.setFocusable(ed);
        txtApellidosEmp.setFocusable(ed);
    ...
    public void listarEmpleados() throws SQLException{
        ...
        for (int i = 0; i < listaEmp.size(); i++) {
            ...
            ob[1] = listaEmp.get(i).getNombres();
            ob[2] = listaEmp.get(i).getApellidos();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 244, 860));
        ...
        txtApellidosEmp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtApellidosEmpActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel17Layout.createSequentialGroup()
                ...
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel17Layout.createSequentialGroup()
                        ...
                        .addGap(12, 12, 12)
                        .addComponent(btnRegistrarEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel17Layout.createSequentialGroup()
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel17Layout.createSequentialGroup()
                        ...
                        .addComponent(txtccEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel17Layout.createSequentialGroup()
                        .addComponent(jLabel12)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txtApellidosEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel17Layout.createSequentialGroup()
                        .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel17Layout.createSequentialGroup()
                                .addComponent(jLabel10)
                                .addGap(34, 34, 34)
                                .addComponent(txtTelefonoEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel17Layout.createSequentialGroup()
                                .addComponent(jLabel9)
                                .addGap(27, 27, 27)
                                .addComponent(txtNombreEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel17Layout.setVerticalGroup(
            ...
            .addGroup(jPanel17Layout.createSequentialGroup()
                ...
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel11)
                    .addComponent(txtccEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(14, 14, 14)
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel9)
                ...
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12)
                    .addComponent(txtApellidosEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel10)
                ...
                .addGap(88, 88, 88)
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnNuevoEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnRegistrarEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnModificarEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(32, 32, 32)
        ...
        getContentPane().add(paneles, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 120, 1120, 860));
    ...
    private void txtApellidosEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtApellidosEmpActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtApellidosEmpActionPerformed
    ...
    private void btnRegistrarEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarEmpActionPerformed
        if (!"".equals(txtccEmp.getText()) || !"".equals(txtNombreEmp.getText()) || !"".equals(txtApellidosEmp.getText()) || !"".equals(txtTelefonoEmp.getText())) {
            
            emp.setCedula(txtccEmp.getText());
            emp.setNombres(txtNombreEmp.getText());
            emp.setApellidos(txtApellidosEmp.getText());
    ...
    private void tableEmpMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableEmpMouseClicked
        ...
        txtNombreEmp.setText(tableEmp.getValueAt(fila, 1).toString());
        txtApellidosEmp.setText(tableEmp.getValueAt(fila, 2).toString());
    ...
    private void menuEliminarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menuEliminarMousePressed
        ...
        if (opt == JOptionPane.YES_OPTION) {
            try {
                empDao.eliminarEmpleado(tableEmp.getValueAt(fila, 0).toString());
            } catch (SQLException ex) {
